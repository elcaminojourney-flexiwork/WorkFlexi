      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (result.error) Alert.alert('Error', 'Failed to resend invite');
            else {
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (result.error) Alert.alert('Error', 'Failed to terminate employee');
            else {
      ...
      >
        {filteredMembers.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            {filter === 'all' && (
              <TouchableOpacity style={styles.emptyStateButton} onPress={() => setShowInviteModal(true)}>
            ...
            return (
              ...
              >
                ...
                <View style={[styles.statusBadge, { backgroundColor: statusStyle.backgroundColor }]}>
                  <Text style={[styles.statusText, { color: statusStyle.color }]}>{member.status}</Text>
                </View>
          ...
          <ScrollView style={styles.modalContent}>
            ...
            <View style={styles.formGroup}>
              ...
              <View style={styles.typeToggle}>
                <TouchableOpacity
                  style={[styles.typeOption, inviteForm.employment_type === 'full_time' && styles.typeOptionActive]}
                  onPress={() => setInviteForm(prev => ({ ...prev, employment_type: 'full_time' }))}
                >
                  <Text style={[styles.typeOptionText, inviteForm.employment_type === 'full_time' && styles.typeOptionTextActive]}>Full-time</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.typeOption, inviteForm.employment_type === 'part_time' && styles.typeOptionActive]}
                  onPress={() => setInviteForm(prev => ({ ...prev, employment_type: 'part_time' }))}
                >
                  <Text style={[styles.typeOptionText, inviteForm.employment_type === 'part_time' && styles.typeOptionTextActive]}>Part-time</Text>
                </TouchableOpacity>
              </View>
            </View>
            <View style={styles.formGroup}>
              ...
              <View style={styles.selectionGrid}>
                {roles.map((role) => (
                  ...
                  >
                    ...
                    <Text style={[styles.selectionChipText, inviteForm.selectedRoles.includes(role.id) && styles.selectionChipTextActive]}>{role.name}</Text>
                    {inviteForm.selectedRoles.includes(role.id) && <Ionicons name="checkmark" size={16} color={palette.purple[500]} />}
                  </TouchableOpacity>
                ))}
              </View>
            </View>
            <View style={styles.formGroup}>
              ...
              <View style={styles.selectionGrid}>
                {venues.map((venue) => (
                  <TouchableOpacity
                    key={venue.id}
                    style={[styles.selectionChip, inviteForm.selectedVenues.includes(venue.id) && styles.selectionChipActive]}
                  ...
                  >
                    ...
                    <Text style={[styles.selectionChipText, inviteForm.selectedVenues.includes(venue.id) && styles.selectionChipTextActive]}>{venue.name}</Text>
                    {inviteForm.selectedVenues.includes(venue.id) && <Ionicons name="checkmark" size={16} color={palette.purple[500]} />}
                  </TouchableOpacity>
                ))}
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  inviteRow: { padding: spacing.md, paddingBottom: 0 },
  inviteButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: palette.purple[500], paddingVertical: spacing.md, borderRadius: borderRadius.lg, gap: spacing.sm },
  inviteButtonText: { color: palette.white, fontWeight: typography.weights.semibold, fontSize: typography.sizes.body },
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: borderRadius.lg, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, marginHorizontal: spacing.md, marginTop: spacing.md },
